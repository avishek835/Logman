...
for (def index:(0..1))  {
	...
	WebUI.setText(findTestObject('Demo/Multiplebrowseropening/Page_JobyCo/input_ctl00ContentPlaceHolder1'), 'avishek101@mailinator.com')
	println ("provide the email id in the id field")
	WebUI.setText(findTestObject('Demo/Multiplebrowseropening/Page_JobyCo/input_ctl00ContentPlaceHolder1_1'), '123456')
